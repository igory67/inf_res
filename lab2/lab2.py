...
def taskf_plot_show(df : pd.DataFrame):
    ...
    plt.title('████████ per year in Russian Federation', fontsize=16, fontweight='bold')
    # plt.title('suicides per year in Russian Federation', fontsize=16, fontweight='bold')
...
print(str(taskg_compute_correlations(yearly_suicides, "year", "suicides_no")).replace('\'', "\""))
